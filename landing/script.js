const translations = {
    en: {
        ...
        feat_invoice_title: "Invoice Generation",
        feat_invoice_desc: "Create professional PDF invoices compatible with the Qualified Invoice System.",
    ...
    ja: {
        ...
        feat_invoice_title: "請求書作成",
        feat_invoice_desc: "インボイス制度に対応したプロ仕様のPDF請求書をワンクリックで生成。",
